...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      strong("HormonomicsDB v1.5(beta)"),
      br(),
      ...
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Instructions",
                          ...
                          in ESI+ mode.")),
                           ...
                           p("Please cite Giebelhaus et al. (https://doi.org/10.12688/f1000research.124194.1) when using HormonomicsDB in
                             any work."),
                           tags$hr(),),
